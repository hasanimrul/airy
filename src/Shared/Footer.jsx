            ...
            <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
                <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-12 gap-y-12 gap-x-8 xl:gap-x-12">
                    <div className="col-span-2 md:col-span-4 xl:pr-8">
                        ...
                        <p className="text-base leading-relaxed text-gray-600 mt-7 text-justify">Energistically incubate professional platforms rather than cross-media manufactured products. Dynamically implement bleeding-edge potentialities.</p>
                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    <p className="text-sm text-gray-600">© Copyright 2023, All Rights Reserved by <span className='text-lg font-bold'>Airy</span></p>
