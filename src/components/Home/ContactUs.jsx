...
const ContactUs = () => {
    AOS.init();
    return (
        <div style={{ backgroundImage: `url(${img})` }} className='grid grid-cols-2 bg-cover bg-center bg-fixed'>
            <div className='mx-5 text-center my-auto  text-white  '>
                ...
                >
                    ...
                    <Link type="button" className="px-8 py-3 mt-5 font-semibold rounded-b-full rounded-r-full border border-gray-400 text-white hover:bg-blue-600 hover:text-white ">Contact Us</Link>
                </div>
            </div>
            <div class=" mx-5">
                ...
                <div class="w-full p-8 my-4">
                    ...
                    <div class="my-2 w-1/2 lg:w-1/4">
                        <button class="uppercase text-sm font-bold tracking-wide bg-blue-600 hover:bg-gray-600 text-gray-100 p-3 rounded-lg w-full 
