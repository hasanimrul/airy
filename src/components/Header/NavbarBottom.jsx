                ...
                <div className="px-4 mx-auto sm:px-6 lg:px-8">
                    <nav className="relative flex items-center justify-around h-16 lg:h-20">
                        <div className="hidden lg:flex lg:items-center lg:space-x-10">
                            ...
                            <Link to="/" title="" className="text-base font-medium text-black hover:bg-gray-300 hover:rounded p-2"> All Collection </Link>

                            <Link to="/" title="" className="text-base font-medium text-black hover:bg-gray-300 hover:rounded p-2"> Drones </Link>

                            <Link to="/" title="" className="text-base font-medium text-black hover:bg-gray-300 hover:rounded p-2"> Accessories </Link>
                        </div>
                        ...
                        <div className="hidden lg:flex lg:items-center lg:space-x-10">
                            {
                                user?.email ?
                                    <Link onClick={handlesignOut} to="/log-in" title="" className="font-medium text-black hover:bg-gray-300 hover:rounded p-2"> Sign Out </Link>
                                    :
                                    <div>
                                        <Link to="/register" title="" className="font-medium text-black mr-5 hover:bg-gray-300 hover:rounded p-2"> Sign up </Link>

                                        <Link to="/log-in" title="" className="font-medium text-black hover:bg-gray-300 hover:rounded p-2"> Sign in </Link>
                                    </div>
                            }
